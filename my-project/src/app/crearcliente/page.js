                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    className="space-y-4 md:space-y-6"
                     action="#">
                        ...
                        <div>
                            <label htmlFor="identificationDocument" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Documento de identidad del cliente:</label>
                        ...
                        <div>
                            <label htmlFor="phone" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Numero telefonico</label>
                            <input 
                            type="text" 
                            name="phone" 
                            value={phone}
                        ...
                        <button type="submit" className=" w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Crear</button>
