...
export default function Registro() {
  const [name, setName] = useState("MI PRIMER NOMBRE");
            ...
            <div class=" p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6">
                ...
                <div>
                  <label
                    for="password"
                    class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-950"
                  >
                    Contraseña
                  </label>
                  <input
                ...
                <button
                  type="submit"
                  class=" w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  Registrarme
                </button>
                <p class="text-sm font-light text-gray-500 dark:text-gray-700">
                  ...
                  <a
                    href="#"
                    class="font-medium text-primary-600 hover:underline dark:text-Emerald-400"
                  >
                    Ir a login
                  </a>
                </p>
